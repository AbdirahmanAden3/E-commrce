  ...
  html += `
    <tr> 
                 ...
                 <div class="d-none">${product.id}</div>   
                  ...
                  <td>
       <input class="input" type="number" value="${product.quantity
    }" width="20px" height="30px" oninput="updateQuantityAndTotal(this, ${product.price
    })">
</td>
              <td id="total_${product.id}">${product.price * product.quantity
    }</td>
