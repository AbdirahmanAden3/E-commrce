...
//            <a href="./cart.html">
//             <button type="button"  class="btn btn-primary text-white " style= "background-color: red;" >
...
//         console.log("LOSSSSSSSSSSSSSSSSSSSSSSSSSS", localstorage);
//         console.log("productItemproductItem", productItem);
...
//         // window.location = "/cart.html"; // Redirect to cart page if product already exists
